...
* 输出接口有一点更新：**去掉了PrintStream功能**。同时，**评测机上提供的加密版接口也将去掉此功能**。

## 其他

* 非加密版下载地址（新版本）：[https://public.resources.buaaoo.top/homeworks/timable-output/timable-output-1.1-raw-jar-with-dependencies.jar](https://public.resources.buaaoo.top/homeworks/timable-output/timable-output-1.1-raw-jar-with-dependencies.jar)
